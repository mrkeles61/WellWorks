  ...
  tr: {
    translation: {
      ...
      health: {
        ...
        electrovitNedir: {
          heroLabel: '',
          heroTitle: 'Su içemeyenler için tasarlandı.',
          heroDesc: 'Unutkanlık, tüketim alışkanlığı ya da su kaybına sebep olacak dış faktörlerin varlığı nedeniyle günlük su ihtiyacını karşılayamayanlar için geliştirilmiş bir elektrolit takviyesidir. Günlük elektrolit ihtiyacınızı karşılayarak dehidrasyonu önlenmesi, vücudun sıvı dengesi, sinir iletimi ve kas fonksiyonlarını destekler. Yorgunluk ve bitkinliğin azalmasına, enerji oluşum metabolizmasına katkıda bulunur.',
          benefits: {
        ...
        electrovitIntro: {
          label: 'Saşe Takviye',
          title: 'Sodyum, Magnezyum ve <0>Potasyum</0> Gücü',
          desc: 'Electrovit, Sodyum, Magnezyum ve Potasyum içeren <0>saşe takviye edici gıda</0>dır. Su içemeyenler için tasarlandı, pratik kullanımıyla elektrolit dengenizi koruyun.',
          feature1: 'Sodyum, Magnezyum ve Potasyum',
          feature2: 'Pratik Saşe Formatı',
          feature3: 'Her An Yanınızda',
  ...
  en: {
    translation: {
      ...
      health: {
        ...
        electrovitNedir: {
          heroLabel: '',
          heroTitle: 'Designed for those who struggle to drink water.',
          heroDesc: 'It is an electrolyte supplement developed for those who cannot meet their daily water needs due to forgetfulness, consumption habits, or external factors causing water loss. By meeting your daily electrolyte needs, it prevents dehydration and supports the body\'s fluid balance, nerve transmission, and muscle functions. It contributes to the reduction of tiredness and fatigue and to energy-yielding metabolism.',
          benefits: {
        ...
        electrovitIntro: {
          label: 'Sachet Supplement',
          title: 'Sodium, Magnesium and <0>Potassium</0> Power',
          desc: 'Electrovit is a <0>sachet supplement</0> containing Sodium, Magnesium and Potassium. Designed for those who struggle to drink water, maintain your electrolyte balance with practical use.',
          feature1: 'Sodium, Magnesium and Potassium',
          feature2: 'Practical Sachet Format',
          feature3: 'Always With You',
