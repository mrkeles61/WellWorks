          ...
          services: {
            ...
            items: [
              ...
              },
              {
                ...
                image: 'https://placehold.co/600x600/1a1a1a/FFF?text=Imera+Niks',
              },
              {
                name: 'Yıldızlı Konser Akşamları',
                description: 'Unforgettable concerts under the stars with Turkey\'s most beloved artists.',
                image: 'https://placehold.co/600x600/1a1a1a/FFF?text=Yildizli+Konserler',
              },
              {
                name: 'Christmas Market',
              ...
              },
              {
                ...
                image: 'https://placehold.co/600x600/1a1a1a/FFF?text=Gusto+Weekend',
              },
              {
                name: 'Business Leisure',
                description: 'Exclusive events combining professional networking with premium leisure.',
                image: 'https://placehold.co/600x600/1a1a1a/FFF?text=Business+Leisure',
              },
            ],
          },
          capabilities: {
