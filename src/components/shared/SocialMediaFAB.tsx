...
const SocialMediaFAB = () => {
    ...
    return (
        ...
        >
            {/* Social Media Icons - Expand upward */}
            ...
            <a
                ...
                className={cn(
                    ...
                    'bg-[#25D366] hover:bg-[#128C7E] transition-all duration-300',
                    'hover:scale-110'
                )}
            ...
            <span
                className={cn(
                    'absolute right-full mr-3 px-4 py-2 bg-gray-900 text-white text-sm rounded-xl',
                    'whitespace-nowrap pointer-events-none shadow-lg flex items-center gap-2',
