...
const ProductCard = ({ product, t }: { product: any, t: any }) => {
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group h-full hover:-translate-y-1 border border-blue-100"
        >
            {/* Image Area - Fills remaining space */}
            <div className="flex-1 bg-gray-50 relative p-4 flex items-center justify-center overflow-hidden min-h-[300px]">
